...
interface PostCardProps {
  post: FeedPost
  onChange: (updated: FeedPost) => void
}
...
export function PostCard({ post, onChange }: PostCardProps) {
  ...
  async function toggleLike() {
    ...
    // Optimistic update: apply the expected result immediately, roll back on error.
    const previous = post
    onChange({
      ...post,
    ...
    <div className="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16">
      <div className="_feed_inner_timeline_content _padd_r24 _padd_l24">
        <div className="_feed_inner_timeline_post_top">
          <div className="_feed_inner_timeline_post_box">
            ...
            <div className="_feed_inner_timeline_post_box_txt">
              ...
              <p className="_feed_inner_timeline_post_box_para">
                ...
                <a href="#0" className="bs-privacy-label" onClick={(e) => e.preventDefault()}>
          ...
          <div className="_feed_inner_timeline_post_box_dropdown">
            ...
            {/* Dropdown (design-only actions) */}
            <div
              className={`_feed_timeline_dropdown _timeline_dropdown${isMenuOpen ? ' show' : ''}`}
            >
      ...
      <div className="_feed_inner_timeline_reaction">
        ...
        <button
          ...
          onClick={() => setCommentFocusSignal((signal) => signal + 1)}
        >
          <span className="_feed_inner_timeline_reaction_link">
            {' '}
            <span>
      ...
      <PostComments
        ...
        onCommentAdded={() => onChange({ ...post, commentCount: post.commentCount + 1 })}
      />
      {isLikersOpen && (
        <LikersModal
          title="Liked by"
          fetchPath={`/posts/${post.id}/likes`}
